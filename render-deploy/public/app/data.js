...
const DEFAULT_CATS = ['TRANSPORTE','LAZER','IFOOD+BESTEIRAS','PRESENTES/SOCIAL','ALIMENTAÇÃO','COMPRAS','ASSINATURAS','OUTROS'];
...
let monthMetricOrder = ['resultado', 'gastos', 'renda', 'projetos'];
